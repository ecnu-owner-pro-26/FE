  ...
  onLoad() {
    ...
    if (info) {
      this.setData({
        ...
        tempBgImage: info.bgImage || 'https://images.unsplash.com/photo-1518173946687-a4c8a9b746f5',
    ...
    setTimeout(() => {
      ...
      if (prevPage) {
        prevPage.setData({
          ...
          'userInfo.bgImage': this.data.tempBgImage
        });
      }
